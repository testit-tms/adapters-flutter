...
part 'model/custom_attribute_option_post_api_model.dart';
part 'model/custom_attribute_option_update_api_model.dart';
part 'model/custom_attribute_put_model.dart';
part 'model/custom_attribute_search_api_model.dart';
part 'model/custom_attribute_search_api_result.dart';
...
part 'model/global_custom_attribute_post_api_model.dart';
part 'model/global_custom_attribute_update_api_model.dart';
...
part 'model/project_shortest_api_result.dart';
