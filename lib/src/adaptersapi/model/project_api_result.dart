...
class ProjectApiResult {
  ...
  @override
  String toString() => 'ProjectApiResult[id=$id, name=$name, isFavorite=$isFavorite, isDeleted=$isDeleted, globalId=$globalId, workflowId=$workflowId, description=$description]';
