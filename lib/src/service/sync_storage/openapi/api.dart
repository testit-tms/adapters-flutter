...
part 'model/set_worker_status_response.dart';
part 'model/shutdown_response.dart';
part 'model/test_result_cut_api_model.dart';
part 'model/test_result_save_response.dart';
