...
class RegisterResponse {
  ...
  @override
  String toString() => 'RegisterResponse[status=$status, message=$message, pid=$pid, testRunId=$testRunId, isMaster=$isMaster]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.isMaster != null) {
      json[r'is_master'] = this.isMaster;
    } else {
      json[r'is_master'] = null;
    }
    return json;
  }
  ...
  static RegisterResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return RegisterResponse(
        ...
        isMaster: mapValueOfType<bool>(json, r'is_master'),
      );
    }
    return null;
  }
