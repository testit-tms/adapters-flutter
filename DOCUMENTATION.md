...
- **[Использование](./doc/usage.md)**: Практические примеры интеграции и использования адаптера в ваших тестах (в т.ч. [batch-режим `importRealtime=false`](./doc/usage.md#4-режим-batch-проливки-importrealtimefalse)).
